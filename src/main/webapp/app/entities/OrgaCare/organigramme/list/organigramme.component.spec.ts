...
describe('Organigramme Management Component', () => {
  let comp: OrganigrammeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(OrganigrammeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.organigrammes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
