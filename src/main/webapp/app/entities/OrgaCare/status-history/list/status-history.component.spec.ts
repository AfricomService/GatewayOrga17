...
describe('StatusHistory Management Component', () => {
  let comp: StatusHistoryComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(StatusHistoryComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.statusHistories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
