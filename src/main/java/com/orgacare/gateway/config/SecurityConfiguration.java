...
import com.orgacare.gateway.security.SecurityUtils;
import com.orgacare.gateway.security.oauth2.AudienceValidator;
import com.orgacare.gateway.security.oauth2.JwtGrantedAuthorityConverter;
import com.orgacare.gateway.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        http.oauth2Login(oauth2 -> oauth2
                ...
                .authenticationSuccessHandler(new RedirectServerAuthenticationSuccessHandler("/orga/"))
            )
